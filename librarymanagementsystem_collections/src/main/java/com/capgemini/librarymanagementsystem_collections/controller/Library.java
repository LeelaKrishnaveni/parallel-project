package com.capgemini.librarymanagementsystem_collections.controller;
...
import com.capgemini.librarymanagementsystem_collections.validations.Validations;
							...
							case 2:
								...
								do {
									...
									try {
										...
										AdminDetails login = service.loginAdmin(email, password);
										flag = true;
									} catch (Exception e) {
										flag = false;
										System.err.println(e.getMessage());
										...
										try {
											...
											case 5:
												...
												if (book_Id == 0) {
													...
													if (remove) {
														...
														System.err.println("The Book is not removed");
													}
												}
												break;
											...
											case 9:
												try {
													...
													List<RequestDetails> requestInfos = service.showRequests();
													System.out.println(
						...
						try {
							...
							case 2:
								do {
									...
									try {
										@SuppressWarnings("unused")
										UserDetails login = service1.loginUser(email, password);
										flag = true;
									} catch (Exception e) {
										flag = false;
										System.err.println(e.getMessage());
									...
									do {
										try {
											...
											case 5:
												...
												try {
													RequestDetails request = service1.bookRequest(userBean, bookBean);
											...
											case 6:
												...
												UserDetails userBean7 = new UserDetails();
												userBean7.setId(user);;
												BookDetails bookBean7 = new BookDetails();
												bookBean7.setId(book);;

												try {
													RequestDetails requestInfo = service1.bookReturn(userBean7, bookBean7);
